...
public class UserClient {
    ...
    public Map<String, Object> publicUser(int idUsuario) {
        Map<Integer, Map<String, Object>> users = publicUsersById(java.util.Collections.singleton(idUsuario));
        return users.get(idUsuario);
    }
}
